...
function init() {
    ...
    const { splines, splinesByConstituents, adjacencyList, pointsThatArePartOfContouringSplines } = computeSplinesByGlobalIndices(similarityGraph, voronoiVerts, yuvImage, imgWidth, imgHeight)
